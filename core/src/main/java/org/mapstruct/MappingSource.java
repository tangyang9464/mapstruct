 ...
 * <p>
 * By default:
 * - Bean parameters have their properties automatically used for implicit mapping
 * - Map parameters in multi-source scenarios don't have their entries automatically used for implicit mapping
 * - Collection and other types are never automatically expanded
 * <p>
 ...
 *
 * <pre><code>
 * // Example: Preventing a bean parameter's properties from being used in implicit mapping
 * {@literal @}Mapper
